...
function problemA() {
  ...
  // promise version
  // ???
  promisifiedReadFile('poem-one/stanza-01.txt').then(function (carlos) {
    //console.log('-- A. callback version --');
    blue(carlos)
  }).catch(function (err) {
...
function problemB() {
  ...
  // promise version
  // ???
  promisifiedReadFile('poem-one/stanza-02.txt').then(function (carlos2) {
    //console.log('-- B. callback version (stanza two) --');
    blue(carlos2)
  }).then(promisifiedReadFile('poem-one/stanza-03.txt').then(function (carlos3) {
    //console.log('-- B. callback version (stanza three) --');
    blue(carlos3)
  })).catch(function (err) {
    //console.error('ERR', err); 
...
function problemC() {
   ...
   *    que los specs estan opinionados y separa la palabra exacata
